...
export const VerifyAction = (data, navigate, setLoading) => {
  ...
  return async (dispatch) => {
    await axios
      .post(baseURL + 'account/verify/', data)
      .then((res) => {
        if (res.status === 200) {
...
export const GetCateogry = () => {
  return async (dispatch) => {
    await axios
      .get(baseURL + `product/main-categories/`)
      .then((res) => {
        dispatch({
          type: 'CAT',
          payload: res.data,
...
export const GetSubCateogry = (id, setData) => {
  return async (dispatch) => {
    await axios
      .get(baseURL + `product/categories/${id}`)
      .then((res) => {
        setData(res.data);
      })
      .catch((err) => {
...
export const GetBanner = () => {
  return async (dispatch) => {
    await axios
      .get(baseURL + `static-data/get-banners/`)
      .then((res) => {
        dispatch({
          type: 'BANNER',
          payload: res.data,
...
export const GetTerms = (setData, setLoading) => {
  return async (dispatch) => {
    await axios
      .get(baseURL + `static-data/terms-and-conditions/`)
      .then((res) => {
        console.log(res.data);
        setData(res.data);
        setLoading(false);
...
export const GetRefund = (setData, setLoading) => {
  return async (dispatch) => {
    await axios
      .get(baseURL + `static-data/refund-cancellation-policy/`)
      .then((res) => {
        console.log(res.data);
        setData(res.data);
        setLoading(false);
